...
namespace IntranetGJAK
{
    public class Startup
    {
        ...
        public Startup(IHostingEnvironment env)
        {
            ...
            .WriteTo.RollingFile(Path.Combine(env.ContentRootPath, "intranet-{Date}.log"), outputTemplate: template)
            .MinimumLevel.Debug()
            .CreateLogger();

            log = Log.ForContext<Startup>();
            log.Information("{AppName}", env.ApplicationName);
            log.Information("{LogPath}", Path.Combine(env.ContentRootPath, "intranet-{Date}.log"));
