<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClassicDemo.aspx.cs" Inherits="$rootnamespace$.ASPNET.ClassicDemo" %>
...
<body>
        ...
        <div class="container">
            <blockquote>
                <p>
                    ...
                    <code>system.webServer.handlers</code> section in the web.config file (Demo folder: "/Other/ASPNET/").
                </p>
            </blockquote>
            <br>
    ...
    <script src="/Scripts/demos.classic.aspx.js"></script>
</body>
</html>